---
title: "Class Project 02-28-2019"
author: "Seeam S. Noor"
date: "February 28, 2019"
output: html_document
---
  
##Looking at Harvard Undergraduate Course Enrollment  
...
```{r data, warning = FALSE, message = FALSE, error = FALSE, echo = FALSE}
...
```{r picture1, warning = FALSE, message = FALSE, error = FALSE, echo = FALSE}
...
```{r picture2, warning = FALSE, message = FALSE, error = FALSE, echo = FALSE}
  x_2019 %>% 
